...
contract NFTMint is ERC721URIStorage {
  ...
  function mintNFT(string memory _tokenURI, uint256 _price, uint256 _royaltyToYou, uint256 _royaltyToCause, address _userWallet) public {
    // get token id
  ...
  function approveNFT(uint256 _tokenId, address _marketplaceAddress) public {
