...
describe("End to end auction tests", function () {
  ...
  beforeEach(async function () {
    ...
    erc20 = await ERC20.deploy("mock erc20", "MMM")
    await erc20.deployed();
    await erc20.mint(user2.address, 100000000000000);
    
    nftAuction = await NFTAuction.deploy();
    await nftAuction.deployed();
    //approve our smart contract to transfer this NFT
    await erc721.connect(user1).approve(nftAuction.address, 1);
    await erc20.connect(user2).approve(nftAuction.address, 100000000000000);
  ...
  describe("Custom auction end to end", async function () {
    ...
    it("should allow multiple bids and conclude auction after end period", async function () {
      nftAuction
        .connect(user2)
        .makeBid(erc721.address, tokenId, erc20.address, 100000000, {
          value: 0,
        });
      ...
      // console.log("auctionBidPeriod: ",auctionBidPeriod);
