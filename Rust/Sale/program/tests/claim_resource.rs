...
mod claim_resource {
    ...
    use mpl_price_sale::{
        accounts as mpl_price_sale_accounts, instruction as mpl_price_sale_instruction,
    ...
    #[tokio::test]
    async fn success() {
        setup_context!(context, mpl_price_sale, mpl_token_metadata);
        ...
        // CreateMarket
        let accounts = mpl_price_sale_accounts::CreateMarket {
        ...
        let data = mpl_price_sale_instruction::CreateMarket {
        ...
        // Buy
        let accounts = mpl_price_sale_accounts::Buy {
            market: market_keypair.pubkey(),
            selling_resource: selling_resource_keypair.pubkey(),
        ...
        let data = mpl_price_sale_instruction::Buy {
        ...
        // CloseMarket
        let accounts = mpl_price_sale_accounts::CloseMarket {
            market: market_keypair.pubkey(),
        ...
        let data = mpl_price_sale_instruction::CloseMarket {}.data();
        ...
        let accounts = mpl_price_sale_accounts::Withdraw {
            market: market_keypair.pubkey(),
            selling_resource: selling_resource_keypair.pubkey(),
            metadata,
            treasury_holder: treasury_holder_keypair.pubkey(),
        ...
        let data = mpl_price_sale_instruction::Withdraw {
            payout_ticket_bump,
        ...
        let (secondary_metadata_creators, _secondary_metadata_creators_bump) =
            mpl_price_sale::utils::find_secondary_metadata_creators(&metadata);

        let accounts = mpl_price_sale_accounts::ClaimResource {
            market: market_keypair.pubkey(),
            treasury_holder: treasury_holder_keypair.pubkey(),
            selling_resource: selling_resource_keypair.pubkey(),
            selling_resource_owner: selling_resource_owner_keypair.pubkey(),
        ...
        let data = mpl_price_sale_instruction::ClaimResource { vault_owner_bump }.data();
