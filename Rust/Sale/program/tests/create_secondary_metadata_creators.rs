...
mod create_secondary_metadata_creators {
    ...
    async fn success() {
        ...
        let (vault_owner, _vault_owner_bump) =
            mpl_price_sale::utils::find_vault_owner_address(
                &resource_mint.pubkey(),
        ...
        let accounts = mpl_price_sale_accounts::CreateSecondaryMetadataCreators {
        ...
        let data = mpl_price_sale_instruction::CreateSecondaryMetadataCreators {
