...
mod resume_market {
    ...
    async fn success() {
        ...
        // SuspendMarket
        let accounts = mpl_price_sale_accounts::SuspendMarket {
            market: market_keypair.pubkey(),
        ...
        let data = mpl_price_sale_instruction::SuspendMarket {}.data();
        ...
        // ResumeMarket
        let accounts = mpl_price_sale_accounts::ResumeMarket {
            market: market_keypair.pubkey(),
            owner: selling_resource_owner_keypair.pubkey(),
            clock: sysvar::clock::id(),
        }
        ...
        let data = mpl_price_sale_instruction::ResumeMarket {}.data();
